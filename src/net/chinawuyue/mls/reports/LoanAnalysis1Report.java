 ...
 * 贷款分析报表一
 */
public class LoanAnalysis1Report extends BaseReport {
	...
	public LoanAnalysis1Report(Context context) {
		super(context);
		this.context = context;
		this.setReportType(ReportType.LoanAnalysis1);
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View contentView, ViewGroup vg) {
			...
			if (contentView == null) {
				synchronized (context) {
					...
					View layout = LayoutInflater.from(context).inflate(
							R.layout.listview_report_loan_analysis1, null);
					// 控制列表项水平滑动
					...
					holder.tvCount14 = (TextView) layout
							.findViewById(R.id.t_count14);
					holder.tvBalance14 = (TextView) layout
							.findViewById(R.id.t_balance14);
					holder.tvCount15 = (TextView) layout
							.findViewById(R.id.t_count15);
					holder.tvBalance15 = (TextView) layout
							.findViewById(R.id.t_balance15);
					holder.tvCount16 = (TextView) layout
							.findViewById(R.id.t_count16);
					holder.tvBalance16 = (TextView) layout
							.findViewById(R.id.t_balance16);
					holder.tvCount17 = (TextView) layout
							.findViewById(R.id.t_count17);
					holder.tvBalance17 = (TextView) layout
							.findViewById(R.id.t_balance17);
					...
					holder.tvSum17 = (TextView) layout
							.findViewById(R.id.t_sum17);
					holder.tvRatio17 = (TextView) layout
							.findViewById(R.id.t_ratio17);
			...
			holder.tvCount14.setText(map.get(COUNT + "14").toString());
			holder.tvBalance14.setText(map.get(BALANCE + "14").toString());
			holder.tvCount15.setText(map.get(COUNT + "15").toString());
			holder.tvBalance15.setText(map.get(BALANCE + "15").toString());
			holder.tvCount16.setText(map.get(COUNT + "16").toString());
			holder.tvBalance16.setText(map.get(BALANCE + "16").toString());
			holder.tvCount17.setText(map.get(COUNT + "17").toString());
			holder.tvBalance17.setText(map.get(BALANCE + "17").toString());
			...
			holder.tvSum17.setText(map.get(SUM + "17").toString());
			holder.tvRatio17.setText(map.get(RATIO + "17").toString());
			if (position % 2 == 0) {
		...
		handler.postDelayed(new Runnable(){
			public void run(){
				...
				if (isNeedUpdate) {
					...
					final DoFetchThread doFetch = new DoFetchThread("RP0002", handler,jsonReq);
